...
<body>
    ...
    <div class="contents">
        ...
        <div class="passenger-info-block">
            <form method="POST" class="pass-info-form-group" action="indexsearch_trip.php" autocomplete="on" name="passenger-form">
                <div class="pass-info-form-fields">
                    <div class="pass-info-form1">
                        <div class="data-form">
                            <label>First Name:</label>
                            <input name="reserve_pFname" type="text" id="PaymentPassengerInfoContent_txtFName" placeholder="First Name" autocomplete="given-name" 
                        ...
                        <div class="data-form">
                            ...
                            <input name="reserve_pLname" type="text" id="PaymentPassengerInfoContent_txtLName" placeholder="Last Name" autocomplete="family-name" 
                            onkeyup="this.value = this.value.toUpperCase();"required/>
                        </div>
                        ...
                        <div class="data-form">
                            ...
                            <div class="gender-radio-div">
                                <input name="reserve_pGender" type="radio" id='radio-Male' value='Male' checked/><label id="gender-lbl" for='radio-Male'>Male</label>
                                <input name="reserve_pGender" type="radio" id='radio-Female' value='Female'/><label id="gender-lbl" for='radio-Female'>Female</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pass-info-form2">
                        <div class="data-form">
                            <label>Email:</label>
                            <input name="reserve_pReEmail" type="email" id="PaymentPassengerInfoContent_txtReEmail" placeholder="juandelacruz@gmail.com" autocomplete="email" required/>
                        </div>

                        <div class="data-form">
                            <label>Mobile No:</label>
                            <input name="reserve_pMobile" type="tel" id="PaymentPassengerInfoContent_txtMobileNo" class="numeric" placeholder="09XXXXXXXXX" pattern="[0][9][0-9]{9}" 
