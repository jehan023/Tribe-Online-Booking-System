...
<body>
    ...
    <div class="contents">
        ...
        <div class="book-trip-panel">
            ...
            <div class="reminders-panel">
                ...
                <div class='see-booking-wrapper'>
                    <button name="see-booking-btn" id="search_my_btn" class='btn-see-booking'>See My Status</button>
                </div>
            </div>
    ...
    <div class="modal-search-container" id="modal-search-container">
        <div class="modal-search-content">
            ...
            <form method="post" class="search-my-form" id="search-my-form">
                <div class="search-my-form-row">
                    <span>Trip ID:</span>
                    <p>(trip id written on your reservation ticket)</p>
                    <input type="text" class="passenger-input-search" name="trip_id-search" id="trip_id-search" placeholder="" required />
                    <span>Mobile Number:</span>
                    <p>(number used in your online booking transaction)</p>
                    <input type="text" class="passenger-input-search" name="contact-search" id="contact-search" placeholder="" required />
                    <span>Lastname:</span>
                    <p>(your lastname applied for reservation)</p>
                    <input type="text" class="passenger-input-search" name="lastname-search" id="lastname-search" placeholder="" onkeyup="this.value = this.value.toUpperCase();" required />
                </div>
    ...
    <script>
        ...
        var modalMyBooking = document.getElementById('modal-search-container');
        // Get the button that opens the modal
        var ebBtn1 = document.getElementById("tncbtn");
        var ebBtn2 = document.getElementById("ppbtn");
        var myBookBtn = document.getElementById('search_my_btn');
        ...
        myBookBtn.onclick = function() {
            modalMyBooking.style.display = "block";
        }
        ...
        closeSpan.onclick = function() {
            modalMyBooking.style.display = "none";
        }
    ...
    <script>
        ...
        var searchButton = document.getElementById('searchPassenger_btn');
        ...
        searchButton.addEventListener('click', function(event) {
            ...
            var tripId = document.getElementById('trip_id-search').value;
            var contact = document.getElementById('contact-search').value;
            var lastname = document.getElementById('lastname-search').value;

            // Perform input validation
            if (tripId === '' || contact === '' || lastname === '') {
                // Display an error message or perform any desired action for incomplete inputs
            ...
            xhr.onload = function() {
                if (xhr.status === 200) {
                    // Display the search result in the designated element
            ...
            xhr.send('trip_id-search=' + encodeURIComponent(tripId) + '&contact-search=' + encodeURIComponent(contact) + '&lastname-search=' + encodeURIComponent(lastname));
        });
    </script>
</body>
